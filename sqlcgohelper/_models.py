...
from sqlalchemy import Boolean, DateTime, Double, ForeignKeyConstraint, Index, Integer, PrimaryKeyConstraint, Text, text
...
class Account(Base):
    ...
    last_updated: Mapped[Optional[datetime.datetime]] = mapped_column(DateTime(True), server_default=text('now()'))
...
class Transaction(Base):
    ...
    __table_args__ = (
        ForeignKeyConstraint(['account_id'], ['budget.account.id'], name='transaction_account_id_fkey'),
